        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button onClick={() => scrollTo('hero')} className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 bg-blue-600 rounded-xl flex items-center justify-center
                            group-hover:bg-blue-500 transition-all shadow-lg shadow-blue-900/50">
              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                  d="M4 7v10c0 1.1.9 2 2 2h12a2 2 0 002-2V7M4 7l8-4 8 4M4 7h16"/>
              </svg>
            </div>
            <span className="font-bold text-white text-[15px] tracking-tight">Schema Genius</span>
          </button>
      ...
      <footer className="border-t border-white/8 py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-sm text-white">Schema Genius</span>
          </div>
          <p className="text-xs text-gray-600">
            © {new Date().getFullYear()} Schema Genius · Built with React, Laravel & ❤️
          </p>
